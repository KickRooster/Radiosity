...
namespace Core
{
	struct GenericPlatformTypes
	{
		...
		typedef WIDECHAR			TCHAR;		// A switchable character  - In-memory only.  Either ANSICHAR or WIDECHAR, depending on a licensee's requirements.														// signed int the same size as a pointer
