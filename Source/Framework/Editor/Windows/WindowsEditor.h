...
namespace Core
{
	class WindowsEditor : public IFramework
	{
		...
		std::unique_ptr<GLFrameBuffer> m_GLGBufferFrameBuffer1x1;
		std::unique_ptr<GLTexture> m_GLPositionAttach1x1;
		std::unique_ptr<GLTexture> m_GLNormalAttach1x1;
		std::unique_ptr<GLFrameBuffer> m_GLGBufferFrameBuffer2x2;
		std::unique_ptr<GLTexture> m_GLPositionAttach2x2;
		std::unique_ptr<GLTexture> m_GLNormalAttach2x2;
		
		std::unique_ptr<RLTexture2D> m_RLBakingObjectPosition1x1;
		std::unique_ptr<RLTexture2D> m_RLBakingObjectNormal1x1;
		std::unique_ptr<RLTexture2D> m_RLBakingObjectPosition2x2;
		std::unique_ptr<RLTexture2D> m_RLBakingObjectNormal2x2;
		...
		std::shared_ptr<Object> createAreaLight(int32 Index, Vector3 Position, Vector3 EulerAngle, int32 XLength, int32 YLength, int32 MaxXLength, int32 MaxYLength, Vector3 Color, float Intensity, Vector3 Energy, LightPrecision Precision);
